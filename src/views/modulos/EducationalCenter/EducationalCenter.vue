  ...
  <v-row class="principal_container">
    ...
    <div class="title">
      <v-col cols="12" md="12" sm="12" xs="12">
        <h3 class="title_section">ESTUDIANTES PCD</h3>
        <br />
      </v-col>
    </div>
    <v-col cols="12">
...
export default class Usuario extends Vue {
  ...
  headers = [
    { text: "ID", value: "id" },
    { text: "Centro Educativo", value: "school_name" },
/*     { text: "Estado", value: "estado_id" },
    { text: "Municipio", value: "municipio_id" },
    { text: "Parroquia", value: "parroquia_id" }, */
    { text: "Dirección", value: "address" },
    { text: "Código DEA", value: "dea_code" },
    { text: "Vinculado", value: "linked" },
    { text: "Cédula Estudiantil", value: "student_card_number" },
    { text: "C.I. Estudiante", value: "student_ci" },
    { text: "Nombre", value: "first_name" },
    { text: "Apellido", value: "last_name" },
    /* { text: "Tipo Discapacidad", value: "tipo_discapacidad_general_id" }, */
    { text: "Nivel Académico", value: "academic_level" },
 /*    { text: "Subnivel Académico", value: "academic_sublevel" }, */
  ...
  openView() {
    this.$router.push({ name: "createstudents" });
  }
