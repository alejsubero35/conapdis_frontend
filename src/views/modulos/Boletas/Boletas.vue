  ...
  <v-row class="principal_container">
    ...
    <div class="title">
      <v-col cols="12" sm="12" md="12">
        <h3 class="title_section">BOLETAS SANCIONATORIAS</h3>
        <br />
      </v-col>
    </div>
    <!--    <v-col cols="12">
...
export default class Usuario extends Vue {
  ...
  async deleteInspeccion(event) {
    /*         let dataUpdate : any = []
        this.dialogDelete = event;
        //this.overlay = true
        const res : any = await boletaModule.delete(this.id_delete);
